...
public class Utils{
	...
	*/
	...
	static func logFlutterMethodCall(_ call: FlutterMethodCall) {
		let noAgrs = {
			Utils.txf_log_info(content: "method=\(call.method)|arguments: nil")
		}
	...
	static func logError(call: FlutterMethodCall, errCode: Int, errMsg: String) {
		let noAgrs = {
			Utils.txf_log_error(content: "method=\(call.method)|arguments=nil|error={errCode: \(errCode), errMsg: \(errMsg)}")
		}
