...
class IDeprecatedTRTCCloud {
 public:
   ...
   * 启用音量大小提示
   *
   * @deprecated v10.1 版本开始不推荐使用，建议使用 {@link enableAudioVolumeEvaluation}(enable,
   * params) 替代之。
   */
   ...
   * 启用音量大小提示
   *
   * @deprecated v11.2 版本开始不推荐使用，建议使用 {@link enableAudioVolumeEvaluation}(enable,
   * params) 替代之。
   */
   ...
   */
  trtc_attribute_deprecated virtual void setRemoteViewFillMode(const char* userId,
                                                               TRTCVideoFillMode mode) = 0;
   ...
   * @deprecated v8.0 版本开始不推荐使用，建议使用 {@link setRemoteRenderParams} 替代之。
   */
  trtc_attribute_deprecated virtual void setRemoteViewRotation(const char* userId,
                                                               TRTCVideoRotation rotation) = 0;
   ...
   * @deprecated v8.0 版本开始不推荐使用，建议使用 {@link startRemoteView} 替代之。
   */
  trtc_attribute_deprecated virtual void startRemoteSubStreamView(const char* userId,
                                                                  TXView rendView) = 0;
   ...
   * @deprecated v8.0 版本开始不推荐使用，建议使用 {@link setRemoteRenderParams} 替代之。
   */
  trtc_attribute_deprecated virtual void setRemoteSubStreamViewFillMode(const char* userId,
                                                                        TRTCVideoFillMode mode) = 0;

  /**
   * 设置辅路画面的顺时针旋转角度
   *
   * @deprecated v8.0 版本开始不推荐使用，建议使用 {@link setRemoteRenderParams}:streamType:params:
   * 替代之。
   */
  trtc_attribute_deprecated virtual void setRemoteSubStreamViewRotation(
      const char* userId,
      TRTCVideoRotation rotation) = 0;
   ...
   */
  trtc_attribute_deprecated virtual void setPriorRemoteVideoStreamType(
      TRTCVideoStreamType type) = 0;
   ...
   * 获取背景音乐总时长（单位：毫秒）
   *
   * @deprecated v7.3 版本开始不推荐使用，建议使用 {@link TXAudioEffectManager} 中的 {@link
   * getMusicDurationInMS} 替代之。
   */
   ...
   *
   * @deprecated v7.3 版本开始不推荐使用，建议使用 {@link TXAudioEffectManager} 中的 {@link
   * setMusicPublishVolume} 和 {@link setMusicPlayoutVolume} 替代之。
   */
   ...
   * 启用视频自定义采集模式
   *
   * @deprecated v8.5 版本开始不推荐使用，建议使用 {@link enableCustomVideoCapture}(streamType,
   * enable) 接口替代之。
   */
   ...
   * 投送自己采集的视频数据
   *
   * @deprecated v8.5 版本开始不推荐使用，建议使用 {@link sendCustomVideoData}(streamType,
   * TRTCVideoFrame) 接口替代之。
   */
   ...
   * 暂停/恢复发布本地的视频流
   *
   * @deprecated v8.9 版本开始不推荐使用，建议使用 {@link muteLocalVideo}(streamType, mute)
   * 接口替代之。
   */
   ...
   * 暂停 / 恢复订阅远端用户的视频流
   *
   * @deprecated v8.9 版本开始不推荐使用，建议使用 {@link muteRemoteVideoStream}(userId, streamType,
   * mute) 接口替代之。
   */
   ...
   * 设置第三方美颜的视频数据回调
   *
   * @deprecated v11.4 版本开始不推荐使用，建议使用 {@link enableLocalVideoCustomProcess} 和 {@link
   * setLocalVideoCustomProcessCallback} 替代之。
   */
  trtc_attribute_deprecated virtual int setLocalVideoProcessCallback(
      TRTCVideoPixelFormat pixelFormat,
      TRTCVideoBufferType bufferType,
      ITRTCVideoFrameCallback* callback) = 0;

/**
 * 获取摄像头设备列表
 *
 * @deprecated v8.0 版本开始不推荐使用，建议使用 {@link TXDeviceManager} 中的 {@link getDevicesList}
 * 接口替代之。
 */
 ...
 * 选定当前要使用的摄像头
 *
 * @deprecated v8.0 版本开始不推荐使用，建议使用 {@link TXDeviceManager} 中的 {@link
 * setCurrentDevice} 接口替代之。
 */
#if TARGET_PLATFORM_DESKTOP
 ...
 */
#if _WIN32
  trtc_attribute_deprecated virtual void startCameraDeviceTest(
      ITRTCVideoRenderCallback* callback) = 0;
#endif
 ...
 */
#if TARGET_PLATFORM_DESKTOP
  trtc_attribute_deprecated virtual void selectScreenCaptureTarget(
      const TRTCScreenCaptureSourceInfo& source,
      const RECT& captureRect,
      bool captureMouse = true,
      bool highlightWindow = true) = 0;
#endif
};
}  // namespace liteav
#endif
